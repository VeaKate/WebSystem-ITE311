                                ...
                                <?php else: ?>
                                    ...
                                    <div class="dropdown" data-bs-display="static">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <form action="<?= base_url('users/delete/' . $searchUser['id']) ?>" method="post">
                                                    <?= csrf_field() ?>
                                                    <button type="submit" class="opt2" onclick="return confirm('Are you sure you want to delete this user?');">
                                                        Delete User
                                                    </button>
                                                </form>
                                            </li>
                                            ...
                                            <div class="modal-content">
                                                <form action="<?= base_url('users/edit/' . $searchUser['id']) ?>" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input type="password" class="form-control" name="password" id="password<?= $searchUser['id'] ?>" required>
                                                            <label for="password<?= $searchUser['id'] ?>">Password</label>
                                                        </div>
                                            ...
                                            <div class="modal-content">
                                                <form action="<?= base_url('users/edit/' . $user['id']) ?>" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input type="password" class="form-control" name="password" id="password<?= $user['id'] ?>" required>
